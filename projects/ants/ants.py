...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        place, rang = self.place, 0
        while place != beehive:
            if place.bees != [] and rang >= self.min_range and rang <= self.max_range:
...
class ContainerAnt(Ant):
    ...
    def action(self, gamestate):
        ...
        "*** YOUR CODE HERE ***"
        if self.place:
            contained = self.place.ant.contained_ant
            if contained:
    ...
    def action(self, gamestate):
        ...
        if self.imposter:
            ...
            while location.exit:
                ...
                a = location.ant
                if a and not a.double_power:
                    a.double_power = True
                    a.damage = a.damage * 2
                if a and isinstance(a, ContainerAnt) and a.contained_ant and not a.contained_ant.double_power:
                    a.contained_ant.double_power = True
                    a.contained_ant.damage = a.contained_ant.damage * 2
...
class Bee(Insect):
    ...
    def action(self, gamestate):
        ...
        else: destination = self.place.exit
