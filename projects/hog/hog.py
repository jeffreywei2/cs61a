...
def is_swap(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    if abs(player_score % 10 - opponent_score % 10) == opponent_score % 100 // 10:
        return True
    else: return False
    # END PROBLEM 4
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    # BEGIN PROBLEM 5
    "*** YOUR CODE HERE ***"
    add0, add1, hog0, hog1 = 0, 0, 0, 0
    while goal > max(score0, score1):
        if who == 0:
            strat0 = strategy0(score0, score1)
            if feral_hogs and abs(strat0 - add0) == 2:
                hog0 = 3
            else: hog0 = 0
            add0 = take_turn(strat0, score1, dice)
            score0 += add0
            score0 += hog0
            who = other(who)
            ...
            if feral_hogs and abs(strat1 - add1) == 2:
                hog1 = 3
            else: hog1 = 0
            add1 = take_turn(strat1, score0, dice)
            score1 += add1
            score1 += hog1
            who = other(who)
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        ...
        if diff > running_high:
            print("{} point(s)! That's the biggest gain yet for Player {}".format(diff, who))
        else:
            diff = running_high
